...
export const tournamentInfo: TournamentInfo = {
  ...
  rules: [
    {
      stage: 'Vòng Bảng (Group Stage)',
      formatDescription: '2 bảng đấu (Bảng A & Bảng B), mỗi bảng 5 cặp thi đấu vòng tròn 1 lượt (1 set 21 điểm).',
      scoringRules: [
        'Thi đấu 1 set chạm 21 điểm (không áp dụng điểm cách 2, bên nào đạt 21 điểm trước là thắng).',
        'Thắng 1 trận nhận 1 điểm, Thua trận nhận 0 điểm.',
        'Quy tắc xếp hạng: 1. Ưu tiên số trận thắng (1 trận thắng = 1 điểm). 2. Nếu đồng số trận thắng: Xét hệ số điểm bị thua trên trận thua (đội bị thua ít điểm hơn / ghi nhiều điểm hơn trong trận thua sẽ xếp trên. Ví dụ: Đội A thua 17-21 [thua 4 điểm], Đội B thua 19-21 [thua 2 điểm] thì Đội B xếp trên). 3. Xét hiệu số điểm thắng/thua toàn giải. 4. Tổng điểm thắng.',
      ],
      advancement: 'Top 2 cặp đấu có thành tích xuất sắc nhất mỗi bảng (Nhất & Nhì) giành quyền vào Bán kết.',
    },
    {
      stage: 'Bán Kết (Semi-Finals)',
      formatDescription: 'Thi đấu chéo giữa 2 bảng: Nhất Bảng A vs Nhì Bảng B & Nhất Bảng B vs Nhì Bảng A (3 set 15 điểm).',
      scoringRules: [
        'Thi đấu Best of 3 (3 set thắng 2), mỗi set chạm 15 điểm (như Chung Kết).',
        'Cặp đôi nào thắng trước 2 set sẽ giành chiến thắng chung cuộc.',
      ],
      advancement: '2 cặp thắng giành vé vào Chung Kết tranh Cúp Vô Địch; 2 cặp thua tranh Hạng Ba.',
    },
    {
      stage: 'Chung Kết & Tranh Hạng Ba (Finals)',
      formatDescription: 'Trận đấu tranh ngôi vị Quán Quân & Tranh Hạng Ba giải ISC Badminton Open 2026.',
      scoringRules: [
        'Trận Chung Kết: Thi đấu Best of 3 (3 set thắng 2), mỗi set chạm 15 điểm.',
        'Trận Tranh Hạng Ba: Thi đấu 1 set chạm 21 điểm.',
      ],
      advancement: 'Xác định chính thức thứ hạng: Quán Quân, Á Quân, Hạng Ba và Hạng Tư.',
    },
  ],
};
