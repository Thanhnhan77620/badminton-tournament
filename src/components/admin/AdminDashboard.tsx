...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigateSection }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-br from-slate-900 via-slate-850 to-blue-950 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-lg relative overflow-hidden">
        {/* Glow decorative */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2.5 shrink-0">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-md shadow-blue-900/40 transition-all flex items-center gap-2 cursor-pointer"
            >
        ...
        <div className="mt-6 pt-6 border-t border-slate-800/80">
          <div className="flex items-center justify-between text-xs mb-2">
            <span className="text-slate-300 font-medium flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-amber-400" /> Tiến độ thi đấu toàn giải:
            </span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-slate-400 ml-1.5">vận động viên</span>
          </div>
          <div className="mt-2 text-[11px] text-blue-600 font-semibold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
        ...
        >
          ...
          <div className="mt-2 text-[11px] text-indigo-600 font-semibold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
        ...
        >
          ...
          <div className="mt-2 text-[11px] text-amber-600 font-semibold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
        ...
        >
          ...
          <div className="mt-2 text-[11px] text-emerald-600 font-semibold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-indigo-950 text-white rounded-2xl p-4 sm:p-5 border border-indigo-900/50 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-indigo-600/30 border border-indigo-500/30 flex items-center justify-center text-indigo-400 shrink-0">
            <Database className="w-5 h-5" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-extrabold text-white">Firebase Firestore Cloud Sync</h4>
              <span
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-xs font-bold transition-all flex items-center justify-center gap-1.5 shrink-0 shadow-xs cursor-pointer"
        >
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-xs p-5 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-3.5 rounded-xl bg-blue-50/50 border border-blue-100 space-y-2">
              <div className="flex items-center justify-between text-xs font-bold text-blue-950 pb-1 border-b border-blue-100">
                <span>BẢNG A (Top 2 đi tiếp)</span>
                <span className="text-blue-600 font-medium text-[11px]">Thắng / Điểm</span>
              </div>
              <div className="space-y-1.5">
                {topA.map((st, i) => (
                  <div
                    key={st.pair.id}
                    className="flex items-center justify-between text-xs bg-white p-2 rounded-lg border border-blue-100"
                  >
                    <div className="flex items-center gap-2 truncate pr-2">
                      <span className="w-5 h-5 rounded bg-blue-600 text-white text-[10px] font-black flex items-center justify-center shrink-0">
                        {i === 0 ? 'A1' : 'A2'}
                      </span>
                      <span className="font-bold text-slate-800 truncate">{st.pair.name}</span>
                    </div>
            ...
            <div className="p-3.5 rounded-xl bg-amber-50/50 border border-amber-100 space-y-2">
              <div className="flex items-center justify-between text-xs font-bold text-amber-950 pb-1 border-b border-amber-100">
                ...
                <span className="text-amber-700 font-medium text-[11px]">Thắng / Điểm</span>
              </div>
              <div className="space-y-1.5">
                {topB.map((st, i) => (
                  <div
                  ...
                  >
                    <div className="flex items-center gap-2 truncate pr-2">
                      <span className="w-5 h-5 rounded bg-amber-500 text-slate-950 text-[10px] font-black flex items-center justify-center shrink-0">
                        {i === 0 ? 'B1' : 'B2'}
                      </span>
                      <span className="font-bold text-slate-800 truncate">{st.pair.name}</span>
                    </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-5 sm:p-6 space-y-4">
          ...
          <div className="space-y-2.5 text-xs">
            <div
              ...
              className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between hover:bg-blue-50 cursor-pointer transition-colors"
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-semibold text-slate-700">1. Thông tin giải &amp; Địa điểm</span>
              </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-semibold text-slate-700">2. Điều lệ, Luật Let &amp; WO</span>
              </div>
              <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
            </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-semibold text-slate-700">3. Danh sách 20 VĐV</span>
              </div>
              <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
            </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-semibold text-slate-700">4. Ghép cặp &amp; Chia 2 Bảng</span>
              </div>
              <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
            </div>
            ...
            <div
              onClick={() => onNavigateSection('results')}
              className="p-2.5 rounded-xl bg-blue-50/70 border border-blue-200/80 flex items-center justify-between hover:bg-blue-100/70 cursor-pointer transition-colors"
            >
              <div className="flex items-center gap-2.5">
                <span className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-[11px] animate-pulse">
                  5
                </span>
                <span className="font-bold text-blue-900">5. Ghi điểm trực tiếp bàn trọng tài</span>
              </div>
          ...
          <div className="pt-3 border-t border-slate-100 space-y-2">
            <div className="flex flex-wrap items-center justify-between gap-2">
              {!showClearConfirm && (
                ...
                >
                  <RotateCcw className="w-3 h-3" /> Xóa Trắng Dữ Liệu Giải Đấu (Khởi Tạo Lại)
                </button>
              )}
            </div>

            {showClearConfirm && (
              <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 space-y-2 text-xs animate-in fade-in">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs cursor-pointer shadow-xs"
                  >
                    Xác Nhận Xóa Trắng
                  </button>
                  <button
