...
export const TournamentHero: React.FC<TournamentHeroProps> = ({
  ...
  return (
    <section className="relative bg-slate-900 text-white overflow-hidden border-b border-slate-800">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-6">
          ...
          <div className="space-y-4 flex-1 max-w-2xl">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-slate-300 mt-2 font-normal">
                {tournament.subtitle} — Hội tụ 10 cặp đôi tranh tài nảy lửa qua 24 trận đấu tranh cúp vô địch và tổng cơ cấu giải thưởng {totalPrizeFormatted}.
              </p>
            </div>

            {/* Time & Venue Information */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <div className="flex items-start gap-3.5 p-3.5 sm:p-4 rounded-xl bg-slate-800/80 border border-slate-700/80 shadow-xs">
                <div className="p-2.5 rounded-lg bg-blue-500/20 text-blue-400 shrink-0 mt-0.5">
                  <Calendar className="w-5 h-5" />
                </div>
                <div className="min-w-0">
                  <p className="text-xs sm:text-sm text-slate-300 font-semibold">Thời gian thi đấu</p>
                  <p className="text-base sm:text-lg lg:text-xl font-bold text-white tracking-wide mt-0.5">{tournament.date}</p>
                  <p className="text-xs sm:text-sm font-semibold text-blue-400 mt-0.5">{tournament.timeRange}</p>
                </div>
              </div>
              ...
              <a
                ...
                className="flex items-start gap-3.5 p-3.5 sm:p-4 rounded-xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 hover:border-indigo-500/60 transition-all group shadow-xs"
                title="Mở địa chỉ trên Google Maps"
              >
                <div className="p-2.5 rounded-lg bg-indigo-500/20 text-indigo-400 group-hover:bg-indigo-600/30 group-hover:text-indigo-300 shrink-0 transition-colors mt-0.5">
                  <MapPin className="w-5 h-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    <p className="text-xs sm:text-sm text-slate-300 font-semibold">Địa điểm tổ chức</p>
                    <ExternalLink className="w-3.5 h-3.5 text-slate-400 group-hover:text-indigo-400 transition-colors" />
                  </div>
                  <p className="text-sm sm:text-base font-bold text-white group-hover:text-indigo-200 transition-colors truncate mt-0.5">
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-1">
              <button
                ...
                className="px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-xs sm:text-sm font-bold rounded-xl shadow-md shadow-blue-950 flex items-center gap-2 transition-all cursor-pointer"
              >
                Xem Lịch & Kết Quả
              ...
              <button
                ...
                className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs sm:text-sm font-bold rounded-xl border border-slate-700 transition-all cursor-pointer"
              >
                Bảng Xếp Hạng A & B
              </button>
              ...
              <button
                ...
                className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-amber-300 hover:text-amber-200 text-xs sm:text-sm font-bold rounded-xl border border-slate-700 transition-all cursor-pointer flex items-center gap-1.5"
              >
            ...
            <div className="h-full bg-slate-800/90 border border-slate-700/80 rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col justify-between space-y-3.5">
              ...
              <div className="grid grid-cols-2 gap-2.5 flex-1">
                <div className="bg-slate-900/70 p-3 rounded-xl border border-slate-700/80 flex flex-col justify-between">
                  ...
                  <div className="mt-2">
                    <p className="text-xl font-black text-white font-display">10 Cặp</p>
                ...
                <div className="bg-slate-900/70 p-3 rounded-xl border border-slate-700/80 flex flex-col justify-between">
                  ...
                  <div className="mt-2">
                    <p className="text-xl font-black text-white font-display">2 Bảng</p>
                ...
                <div className="bg-slate-900/70 p-3 rounded-xl border border-slate-700/80 flex flex-col justify-between">
                  ...
                  <div className="mt-2">
                    <p className="text-xl font-black text-white font-display">24 Trận</p>
