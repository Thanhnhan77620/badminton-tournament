        ...
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600">
              Tổng quỹ thưởng <strong>{formatCurrency(totalPrize)}</strong>: Nhất, Nhì, Ba nhận <strong>Huy Chương &amp; Tiền Mặt</strong>; Hạng Tư nhận <strong>Tiền Mặt</strong>
            </p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 pt-3 border-t border-slate-200/80 flex items-baseline justify-between gap-1">
                  <span className="text-xs text-slate-400 font-medium shrink-0">Tiền thưởng:</span>
                  <span className={`text-lg sm:text-xl font-extrabold tabular-nums whitespace-nowrap tracking-tight ${style.amountColor}`}>
