      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500">
                Nhánh đấu bán kết, tranh hạng ba và trận chung kết tranh cúp vô địch
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {isFinalFinished ? (
              <span className="text-xs font-bold text-amber-800 bg-amber-100 border border-amber-300 px-3 py-1 rounded-full flex items-center gap-1.5">
              ...
              <span className="text-xs font-bold text-blue-800 bg-blue-100 border border-blue-300 px-3 py-1 rounded-full flex items-center gap-1.5">
                ...
                Đang Thi Đấu Vòng Bảng • Sơ Đồ Chờ
              </span>
            )}
          </div>
        </div>
